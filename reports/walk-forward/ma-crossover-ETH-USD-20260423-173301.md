# Walk-Forward Report: ma-crossover / ETH-USD
...
- IS->OOS Sharpe drop 91.27% > max 30.00%
...
| OOS Avg PF | 4.216 |
| OOS Max DD | 4.80% |
| OOS Avg Total Return | 0.67% |
| IS->OOS Sharpe Drop | 91.27% |
...
|---|---|---|---|---|---|---|---|---|---|
| 0 | 17-11-09->18-11-08 | 18-11-09->19-05-09 | shortEma=10, longEma=50, atrPeriod=14 | 0.28 | 1.70 | 10.14 | 10.00 | 0.7% | 3 |
...
| 12 | 23-11-02->24-10-31 | 24-11-01->25-05-01 | shortEma=30, longEma=100, atrPeriod=14 | 1.42 | 0.00 | 0.00 | 0.00 | 0.0% | 0 |
